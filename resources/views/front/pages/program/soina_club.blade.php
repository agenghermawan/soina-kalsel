...
@section('content')
    ...
    <div class="container my-5">
        <h3 class="ubuntu-bold text-black text-center mb-2">
            Apa itu SOIna Klub?
        </h3>
        <div class="row">
            <div class="col-md-12">
                <p class="text-black ubuntu-medium text-sm">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ol>
                    ...
                    <li>
                        Mensosialisakan sistem pendataan secara berkala untuk atlet, partner, pelatih, relawan, pemuda - pemudi, atlet muda (YA) dan keluarga                    </li>
